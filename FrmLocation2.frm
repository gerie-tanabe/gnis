...
Begin VB.Form FrmLocation2 
   ...
   ClientTop       =   75
   ClientWidth     =   5070
   Icon            =   "FrmLocation2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "FrmLocation2.frx":3452
   ScaleHeight     =   4740
   ScaleWidth      =   5070
   ...
   Begin Rave_Buttons.RaveButtons RaveClose 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "FrmLocation2.frx":D270
      PICN            =   "FrmLocation2.frx":D28C
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   Begin Rave_Buttons.RaveButtons cmdOK 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "FrmLocation2.frx":DF66
      PICN            =   "FrmLocation2.frx":DF82
      UMCOL           =   -1  'True
      SOFT            =   -1  'True
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmLocation2"
...
Private Sub cmdOK_Click()
    FrmGCPDS.TxtERegion = Trim(StrConv(Me.TxtRegion.Text, vbUpperCase))
    FrmGCPDS.TxtEProvince = Trim(StrConv(Me.TxtProvince.Text, vbUpperCase))
    FrmGCPDS.TxtEMunicipality = Trim(Me.TxtMunicipality.Text)
    FrmGCPDS.TxtEBarangay = Trim(Me.TxtBarangay.Text)
    Unload Me
End Sub
