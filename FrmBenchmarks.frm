...
Begin VB.Form FrmBenchmarks 
   ...
   Begin Rave_Buttons.RaveButtons RaveSearch 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "FrmBenchmarks.frx":0442
      PICN            =   "FrmBenchmarks.frx":045E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmBenchmarks"
...
Private Sub LstResults_DblClick()
          ...
          rstBenchmarks.Find "stat_name like '" & Trim(Replace(Me.LstResults.SelectedItem.Text, "'", "''")) & "'", , adSearchForward
          If rstBenchmarks.EOF = True Then
             MsgBox "The benchmark you're searching for don't exist in the current recordset.", vbInformation, "GNIS"
             rstBenchmarks.MoveFirst
          End If
          FrmGCPDS.SetToolBarStatusBM
          Unload Me
End Sub
...
Private Sub RaveSearch_Click()
    ...
    Dim i As Integer
        rst.Open "Select stat_name from benchmarks where stat_name like '%" & Trim(Replace(Me.TxtName, "'", "''")) & "%'", cnn, adOpenStatic, adLockOptimistic
    ...
    If rst.RecordCount > 0 Then
       ...
       If rst.RecordCount = 1 Then
          rstBenchmarks.MoveFirst
          rstBenchmarks.Find "stat_name like '" & Trim(Replace(Me.TxtName, "'", "''")) & "'", , adSearchForward
