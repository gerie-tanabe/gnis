...
Begin VB.Form FrmSearchTriangulation 
   BackColor       =   &H00E0E0E0&
   ...
   EndProperty
   Icon            =   "FrmSearchTriangulation.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3165
   ...
   Begin Rave_Buttons.RaveButtons RaveSearch 
      ...
      MCOL            =   16777215
      MPTR            =   1
      MICON           =   "FrmSearchTriangulation.frx":0442
      PICN            =   "FrmSearchTriangulation.frx":045E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   2
      NGREY           =   0   'False
   ...
   End
End
Attribute VB_Name = "FrmSearchTriangulation"
...
Private Sub LstResults_DblClick()
          ...
          rstTriangulation.Find "stat_name = '" & Trim(Replace(Me.LstResults.SelectedItem.Text, "'", "''")) & "'", , adSearchForward
...
Private Sub RaveSearch_Click()
    ...
    Dim i As Integer
        rst.Open "Select stat_name from triangulation where stat_name like '%" & Trim(Replace(Me.TxtName, "'", "''")) & "%'", cnn, adOpenStatic, adLockOptimistic
    ...
    If rst.RecordCount > 0 Then
       ...
       If rst.RecordCount = 1 Then
          rstTriangulation.MoveFirst
          rstTriangulation.Find "stat_name like '%" & Trim(Replace(Me.TxtName, "'", "''")) & "%'", , adSearchForward
          
          If rstTriangulation.EOF = True Then
             MsgBox "The station you're searching for don't exist.", vbInformation, "GNIS"
             rstTriangulation.MoveFirst
          End If
